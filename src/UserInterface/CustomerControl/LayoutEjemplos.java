...
public class LayoutEjemplos {
        ...
        private Label lblTitulo = new Label("SEXO", Color.BLACK, new Font("MesloLGL Nerd Font", Font.BOLD, 20)),
                        lblIdSexo = new Label("Codigo:      ", SwingConstants.RIGHT),
                        lblNombre = new Label("Descripción: ", SwingConstants.RIGHT),
                        lblTotalReg = new Label("  0 de 0  ", SwingConstants.CENTER);
        private TextField txtIdSexo = new TextField(" ", 20),
        ...
        private Font fontTilte = new Font("MesloLGL Nerd Font", Font.BOLD, 20),
        ...
        private void ejemploAddControls() {
                ...
                // public Dimension getPreferredSize () { return new
                // Dimension(getWidth(),getHeight()); } };
                // @Override public Dimension getPreferredSize () { return
                // super.getPreferredSize().heightToWidthRatio(1);} };
        ...
        public void controls() {
                ...
                // add(btn);
                // }
                Label titulo = new Label("Compre algo ahora", Color.DARK_GRAY,
                                new Font("MesloLGL Nerd Font", Font.BOLD, 16)),
                                nombre = new Label("Nombre:"),
                                direccion = new Label("Dirección:"),
                                pago = new Label("Método de pago:"),
                                telefono = new Label("Teléfono:"),
                                ciudad = new Label("Ciudad:"),
                                provincia = new Label("Provincia:", Color.DARK_GRAY,
                                                new Font("MesloLGL Nerd Font", Font.BOLD | Font.LAYOUT_RIGHT_TO_LEFT,
                                                                12));
                ...
                gbc.ipadx = 500;
                gbc.gridwidth = GridBagConstraints.REMAINDER;
                pnlTabla.add(new Label("Loading data...", 10));
                pnl.add(pnlTabla, gbc);
